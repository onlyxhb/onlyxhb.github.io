...
<embed src="../src/Foo/index.md#RE-/<table>[^]+?[\r\n]<\/table>/"></embed>

## 反馈与共建

请访问 [GitHub](https://github.com/onlyxhb/onlyxhb.github.io/issues) 或加入讨论群：

<embed src='../src/Foo/index.md#RE-/<img data-type="dingtalk"[^>]+\/>[\r\n\s]*<img data-type="wechat"[^>]+\/>/'></embed>
